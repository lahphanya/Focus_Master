...
<img width="2561" height="2403" alt="Image" src="https://github.com/user-attachments/assets/76c9ab27-7d8c-4a54-bc4f-0f4f72857bb9" />
<img width="1911" height="739" alt="Image" src="https://github.com/user-attachments/assets/bb908d5a-d8b5-4577-a50e-100f42270a67" />

### 2. 실시간 모니터링 및 동적 캘리브레이션
...
> <img width="2560" height="1528" alt="Image" src="https://github.com/user-attachments/assets/5adfaa1d-c0b6-4d38-8e23-86254cd5a402" />

### 3. 예외 처리 및 방해 요소 감지

> 고개를 기준치(0.7) 이상으로 푹 숙인 상태여도, 손의 이동 수치(0.015)가 감지되면 '필기중'으로 정상 판별하여 알람을 울리지 않습니다. 반면, 스마트폰을 화면에 노출하거나 고개를 화면 밖으로 돌리거나 필기 없이 엎드리거나 뒤로 눕게되면 화면 전체에 붉은 오버레이와 함께 즉각적인 사이렌 경고가 발생합니다.

| 판별 상태 | 감지 화면 (스크린샷) | 작동 조건 및 상세 설명 |
| :---: | :---: | :--- |
| **정상 (필기중)** | <img src="https://github.com/user-attachments/assets/fe2fbfa4-f5c7-4aa8-a48b-8f586e1346f5" width="720"> | 고개를 임계점 이상 숙였으나, 손의 움직임이 교차 감지되어 알람 발생이 안전하게 유예된 상태입니다. |
| **졸음 감지** | <img src="https://github.com/user-attachments/assets/9df3df7d-37e1-4af5-9b49-005c67bc35be" width="720"> | 손의 움직임(필기) 없이 고개를 푹 숙인 상태가 5초 이상 연속으로 지속되었을 때 발생합니다. |
| **전자기기 감지** | <img src="https://github.com/user-attachments/assets/f249a012-33b8-43b8-92fc-0a2e1be6adbd" width="720"> | 학습에 방해되는 전자기기(스마트폰 등)가 카메라 앵글 내에 노출되었을 때 즉각 발생합니다. |
| **고개 돌림 (딴짓)**| <img src="https://github.com/user-attachments/assets/5ac7fdaa-5fd4-4e55-9e9a-2f0fb374299c" width="720"> | 정면(모니터)을 이탈하여 좌우로 고개를 과도하게 돌려 시선이 분산되었다고 판단될 때 발생합니다. |
| **누움 / 뒤척임** | <img src="https://github.com/user-attachments/assets/eaca99a2-a486-452e-bf6b-e14a28ab81f6" width="720"> | 의자에 과도하게 기대어 눕거나 고개를 뒤로 젖혀 상하 각도가 임계점(0.45) 이하로 떨어질 때 발생합니다. |

### 4. 통계 및 분석 대시보드

> 학습이 종료된 후 '통계 및 분석' 탭으로 이동하면, 데이터베이스에 누적된 기록을 바탕으로 Altair 라이브러리를 활용한 시각화 차트를 제공합니다. 시간대별 집중력 흐름과 방해 요소(졸음, 고개 돌림, 전자기기 등)의 비율을 객관적인 지표로 확인하여 학습 습관을 개선할 수 있습니다. 
> <img width="2561" height="2532" alt="Image" src="https://github.com/user-attachments/assets/d82b32e2-0477-41d4-8947-e79d6f46acde" />
